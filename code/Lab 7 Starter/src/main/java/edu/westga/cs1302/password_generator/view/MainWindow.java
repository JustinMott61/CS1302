...
public class MainWindow {
	...
	void initialize() {
		...
		this.generatePassword.setOnAction((event) -> {
			try {
	...
	private void bindComponentsToViewModel() {
		...
		this.mustIncludeDigits.selectedProperty().bindBidirectional(this.viewModel.digitsNeeded());
		this.mustIncludeLowerCaseLetters.selectedProperty().bindBidirectional(this.viewModel.lowercaseNeeded());
		this.mustIncludeUpperCaseLetters.selectedProperty().bindBidirectional(this.viewModel.uppercaseNeeded());
		this.output.textProperty().bindBidirectional(this.viewModel.resultedPassword());
	}
}
